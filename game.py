...
#Fondo de pantalla
fondo_pant = pygame.image.load('img/Background/0.png').convert()
...
while True:
    ...
    #Dibujo del titulo
    title = font.render("EL VIAJE DEL VALIENTE", True, ( 155, 255, 213 ))
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_UP:
                ...
                if selected_option == 0:
                    ...
                    pygame.quit()
                    subprocess.call(["python", "Lancelot.py"])
